...
MESSAGE_MAP_ADOPT_RKZ = {
    ...
    u"общая информация": {
        "command": u"О банке",
        "previous_commands": ["Общая информация"],
        "next_commands": [u"О банке"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u""" 
            Крупнейший универсальный банк Российской Федерации и стран СНГ. Сбербанку принадлежит 79,2% акций и 20,8% акции  принадлежит Банку BNP PARIBAS.
