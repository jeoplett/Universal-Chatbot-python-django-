...
Наше видение - предоставлять финансовые решения, направленные на улучшение качества жизни наших потребителей.
    ...
    u"наши ценности": {
        ...
        "previous_commands": ["задать вопрос"],
        "next_commands": [u"Да (расскажи про ценности)", u"Нет (не надо про ценности)", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
...
ВСЕ - ДЛЯ КЛИЕНТА
    ...
    u"рабочие моменты": {
        ...
        "previous_commands": ["задать вопрос"],
        "next_commands": [u"Наши ценности", u"Рабочий график", u"Мотивация денежная", u"Отпуск", u"Карьера", u"Плюшки и бонусы", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Да, в работе много тонконстей. Прежде чем говорить о них, очень рекомендуем сперва ознакомиться с нашими ценностям (если не было возможности сделать это раньше)."],
        "re": [u"момент", u"ситуац", u"рабоч", u"cetelem", u"bank"],
        "type": "info"
    },
    u"рабочий график": {
        "command": u"Рабочий график",
        "previous_commands": ["рабочие моменты"],
        "next_commands": [u"График", u"Обед", u"Здесь нет моего случая", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Это и время прихода, и ухода, и обед. Что конкретно тебя интересует?"],
        "re": [u"график", u"врем", u"приход", u"уход"],
        "type": "info"
    },
    u"график": {
        "command": u"График",
        "previous_commands": ["рабочий график"],
        "next_commands": [u"рабочий график", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"По графику работы, который ты можешь посмотреть в системе verint. Система доступна по ссылке http://spwfmapp01:7001/wfo  Временный пароль, если что, ты можешь узнать у своего руководителя или специалиста по персоналу."],
        "re": [u"начиан", u"заканч"],
        "type": "info"
    },
    u"обед": {
        "command": u"Обед",
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Уточни этот вопрос у своего руководителя. А в остальном - приятного аппетита :)"],
        "re": [u"обед", u"перерыв"],
        "type": "info"
    },
    u"здесь нет моего случая": {
        ...
        "previous_commands": ["рабочий график"],
        "next_commands": [u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
    ...
    u"мотивация денежная": {
        "command": u"Мотивация денежная",
        "previous_commands": ["рабочие моменты"],
        "next_commands": [u"Мой оклад", u"Мотивационная программа", u"Здесь нет моего случая", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Мотивация - это важно. Что конкретно тебя интересует?"],
        "re": [u"мотив", u"денеж"],
        "type": "info"
    },
    u"мой оклад": {
        "command": u"Мой оклад",
        "previous_commands": ["мотивация денежная"],
        "next_commands": [u"Мотивация денежная", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Ты не знаешь свой оклад? Это меня очень удивляет! Обратись к своему руководителю или в отдел кадров за этой информацией."],
        "re": [u"мотив", u"денеж", u"приход", u"уход"],
        "type": "info"
    },
    u"мотивационная программа": {
        "command": u"Мотивационная программа",
        "previous_commands": ["мотивация денежная"],
        "next_commands": [u"Мотивация денежная", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Мотивационную программу ты можешь посмотреть у своего Супервайзера!"],
        "re": [u"мотив", u"програм"],
        "type": "info"
    },
    u"отпуск": {
        "command": u"отпуск",
        "previous_commands": ["рабочие моменты"],
        "next_commands": [u"Первый отпуск", u"Заявление на отпуск", u"Отпускные", u"Здесь нет моего случая", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Куда же без отпуска! О чем хочешь узнать?"],
        "re": [u"отпуск"],
        "type": "info"
    },
    u"первый отпуск": {
        "command": u"Первый отпуск",
        "previous_commands": ["отпуск"],
        "next_commands": [u"Отпуск", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"В первый отпуск можно пойти через 6 месяцев после начала работы. Для того, чтобы узнать конкретные даты, уточни этот  вопрос с руководителем и специалистом по персоналу."],
        "re": [u"отпуск"],
        "type": "info"
    },
    u"заявление на отпуск": {
        "command": u"Заявление на отпуск",
        "previous_commands": ["отпуск"],
        "next_commands": [u"Отпуск", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        ...
        "answer_func": "answerEMPTY",
        "answer_text": [u"""
Для того, чтобы пойти в ежегодный оплачиваемый отпуск, необходимо:
    1) явиться в офис за 14 календарных дней до начала отпуска,
    2) написать заявление на отпуск,
    3) согласовать заявление с Руководителем,
    4) передать его Специалисту по персоналу,
    5) подписать приказ о предоставлении ежегодного отпуска.
Если тебе нужно предоставить отпуск без сохранения заработной платы, то ты можешь подать заявление за один день до его начала, также согласовав его с Руководителем.        
        """],
        "re": [u"отпуск"],
        "type": "info"
    },
    ...
    u"карьера": {
        "command": u"Карьера",
        "previous_commands": ["рабочие моменты"],
        "next_commands": [u"Возможно ли повышение", u"Карьерный рост", u"Профессилнальное развитие", u"Тренинг командообразования", u"Тренинг наставничества", u"Управленческие тренинги", u"Навыковый тренинг", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"При трудоустройстве ты проходил базовое обучение, и получил базовые знания. Для того. Чтобы бсотрудник был  эффективным в своей работе, для тебюя разработана программа профессионального развития. Ты будешь проходить тренинги и обучения и развиваться профессионально и личностно."],
        "re": [u"карьера"],
        "type": "info"
    },
    u"возможно ли повышение": {
        "command": u"Возможно ли повышение",
        "previous_commands": ["карьера"],
        "next_commands": [u"Карьера", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Конечно возможно! Все зависит от твое целеустремленности!"],
        "re": [u"повышен"],
        "type": "info"
    },
    u"карьерный рост": {
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Обрати внимание, какие карьерные ступени возможны в зависимости от особенностей твоего подразделения:  Младший специалист - Специалист - Старший/Ведущий Специалист - Супервайзер - Руководитель группы. Для того , чтобы получить повышение, тебе необходимо стать профессионалом своей деятельности! Ты можешь прокачать свои навыки на тренингах."],
        "re": [u"рост", u"карьер"],
        "type": "info"
    },
    u"профессилнальное развитие": {
        "command": u"Профессилнальное развитие",
        "previous_commands": ["карьера"],
        "next_commands": [u"Карьера", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Мы уделяем большое время развитию своих сотрудников. Могу рассказать подробнее."],
        "re": [u"професс", u"развит"],
        "type": "info"
    },
    u"тренинг командообразования": {
        "command": u"Тренинг командообразования",
        "previous_commands": ["карьера"],
        "next_commands": [u"Карьера", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Это очень интересный формат тренинга -  по-другому называется Тимбилдинг. Ты твоя команда проходят задания в необычных условиях. К примеру, выез д на тур базу или в лес.  Такие мероприятия  способствуют сплочение коллектива и хорошему взаимодействию среди коллег."],
        "re": [u"трен", u"команд"],
        "type": "info"
    },
    u"тренинг наставничества": {
        "command": u"Тренинг наставничества",
        "previous_commands": ["карьера"],
        "next_commands": [u"Карьера", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
    ...
    u"управленческие тренинги": {
        "command": u"Управленческие тренинги",
        "previous_commands": ["карьера"],
        "next_commands": [u"Карьера", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Для того, чтобы стать хорошим руководителем, наши сотрудники проходят Управленческие тренинги"],
        "re": [u"трен", u"управлен"],
        "type": "info"
    },
    u"навыковый тренинг": {
        "command": u"Навыковый тренинг",
        "previous_commands": ["карьера"],
        "next_commands": [u"Карьера", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"На навыковых тренингах ты сможеншь получить знания. Наработать умения и получить конкретный навык, который поможет тебе в работе."],
        "re": [u"трен", u"навык"],
        "type": "info"
    },
    u"плюшки и бонусы": {
        "command": u"Плюшки и бонусы",
        "previous_commands": ["рабочие моменты"],
        "next_commands": [u"Льготное кредитование", u"ДМС", u"Ипотека по сниженной ставке", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Работая в нашем Банке, ты можешь воспользоваться рядом преимуществ, они ниже.."],
        "re": [u"плюшк", u"бонус", u"преимущ"],
        "type": "info"
    },
    u"льготное кредитование": {
        "command": u"Льготное кредитование",
        "previous_commands": ["плюшки и бонусы"],
        "next_commands": [u"Плюшки и бонусы", u"Рабочие моменты", u"Начать заново"],
        "repeat_last_command_text": "false",
        "repeat_last_command_next_commands": "false",
        "repeatable_text": "true",
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"На нашем корпоративном портале, во вкладке 'Льготы сотрудникам', ты можешь посмотреть все виды льготного кредитования."],
        "re": [u"льгот", u"кредит"],
        "type": "info"
    },
    u"дмс": {
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"Спустя пол года работы, тебе будет доступно Дополнительное Медицинское Страхование и бесплатное обслуживание в Медицинских Центрах города Саратова. Более подробную информацию ты можешь посмотреть на нашем корпоративном портале во вкладке 'Льготы сотрудникам'."],
        "re": [u"дмс", u"медиц", u"страх"],
        "type": "info"
    },
    u"ипотека по сниженной ставке": {
        ...
        "repeatable_next_commands": "true",
        "answer_func": "answerEMPTY",
        "answer_text": [u"У тебя есть возможность взять ипотеку по сниженной процентной ставке в Сбербанке. Узнай детали на корпоративном портале."],
